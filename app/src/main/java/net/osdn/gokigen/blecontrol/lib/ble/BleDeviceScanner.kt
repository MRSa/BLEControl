...
import net.osdn.gokigen.blecontrol.lib.ble.IBleControl.IBleControlCallback

class BleDeviceScanner(private val context: FragmentActivity, private val bleAdapterGetter: MyBleAdapter, private val callback: IBleControlCallback)
{
